...
public class UserController {
	...
	public @ResponseBody Patient getPatientById(@PathVariable(UserSvcApi.ID_PARAMETER) long id, HttpServletResponse response)
	{
	...
	public @ResponseBody Doctor getDoctorById(@PathVariable(UserSvcApi.ID_PARAMETER) long id, HttpServletResponse response)
	{
		Doctor doctor = null;
